@include('partials.nav')
    ...
    <div class="container site-section" id="information">
        <h1>¿Quiénes Somos?</h1>
        ...
        <div class="container site-section">
            ...
            <div class="row site-section" style="border-width: 0px;border-radius: 0px;margin: 32px;padding: 37px;height: 421px;">
                <div class="col-md-4" style="height: 349px;text-align: center;padding: 2px;margin: 0px;border-radius: 0px;background-color: #96cbf2;border-bottom-left-radius: 0px;opacity: 1;filter: blur(0px) hue-rotate(0deg) invert(0%) sepia(0%);border-width: 0px;border-right-width: 0px;border-right-style: dashed;width: 162px;"><i class="material-icons" style="text-align: center;">account_balance</i>
                    <h1 style="font-size: 15px;text-align: center;">ADMINISTRATIVO</h1>
                    <p></p>
    ...
    <div>
        <div class="container site-section" id="Gallery">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/gallery/Ima4.jpg"></div>
                </div>
                <div class="col-md-4">
                    <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/gallery/5.jpg"></div>
                </div>
                <div class="col-md-4">
                    <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/gallery/6.jpg"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="dark-section-ubication">
            ...
            <section class="bg-light">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-10 col-md-6 col-lg-4 offset-sm-1 offset-md-3 offset-lg-0 order-md-12 order-lg-6" style="margin-top: 20px;">
                            <div class="border rounded shadow bg-white" data-aos="fade" data-aos-duration="600" data-aos-delay="350" data-aos-once="true">
                        ...
                        <div class="col-sm-10 col-md-6 col-lg-4 offset-sm-1 offset-md-0 offset-lg-0 order-md-6 order-lg-12" style="margin-top: 20px;">
                            <div class="border rounded shadow bg-white" data-aos="fade" data-aos-duration="600" data-aos-delay="500" data-aos-once="true">
                    ...
                    <div class="row">
                        <div class="col-sm-10 col-md-6 col-lg-4 offset-sm-1 offset-md-0 offset-lg-2" style="margin-top: 20px;">
                            <div class="border rounded shadow bg-white" data-aos="fade" data-aos-duration="600" data-aos-delay="200" data-aos-once="true">
                        ...
                        <div class="col-sm-10 col-md-6 col-lg-4 offset-sm-1 offset-md-0" style="margin-top: 20px;">
                            <div class="border rounded shadow bg-white" data-aos="fade" data-aos-duration="600" data-aos-delay="350" data-aos-once="true">
        ...
        <footer>
            <div class="container">
                <div class="row" style="margin-top:20px;">
                    <div class="col-md-5 item text" style="margin-bottom:0px;">
                        <h3>desarrollado por</h3>
                        <p class="logoU"><img src="assets/img/logos/LOGO%20IG%20NEGRO%20(1).png" width="200" height="200" style="filter: blur(0px) brightness(65%) contrast(200%);"><img class="img-fluid" src="assets/img/logos/Logo-UNA-Rojo_FondoTransparente.png" width="125" style="filter: contrast(200%);"></p>
                    </div>
                    <div class="col-sm-6 col-md-4 item" style="margin: 0px;padding: -5px;width: 168px;">
                        <h3>CONTÁCTOS</h3>
                        <ul>
                            <li style="font-size: 15px;">CORREO: ligacomunaldelagua@gmail.com</li>
                ...
                <p class="copyright" style="filter: blur(0px) contrast(92%) grayscale(0%) saturate(115%) sepia(0%);opacity: 0.88;">Created by NEPV © 2020</p>
            </div>
        </footer>
    </div>
