	...
	<div class="content-wrapper">
	 ...
	 <section class="content-header">
		...
		<section class="content">
			<form action="{{ route('galeria.update', $galeria->idGaleria) }}" method="POST" enctype= "multipart/form-data">		
		@method('PUT')
		@csrf
        <div class="container">
								...
								<form class="form-horizontal" method="PUT">
										<fieldset>
												...
												<div class="form-group row">
												 ...
												 <div class="form-group row">
														<span class="col-md-2 col-md-offset-2 text-center"></i></span>
														 <img width="150px" src="{{ Storage::url ($galeria->Nombre)}}">	
												...
												<div class="form-group row">
														...
														<div class="col-sm-13 col-xs-13" align="center">
														 ...
														 <a href="{{route('buscargaleria')}}" class="btn btn-success border rounded">Regresar</a>
												</div>                   
			</form>
		</section>
		<!-- /.content -->
