  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
    ...
    <section class="content">
      <form method="GET" action="{{ route('buscargale')}}">
      @if($searchm)
          <h6>
...
<div class="container">
 ...
 @endforeach 
  ...
  <tr>
    ...
    <td>
    <img width="100px"src="{{ Storage::url ($gal->Nombre)}}">
    </td>
    <td>
      <a href="{{route('galeria.editar', $gal)}}" class="btn btn-primary border rounded">Editar</a>
      <form action="{{ route('galeria.eliminar', $gal) }}" class="d-inline" method="POST">
    @method('DELETE')
    @csrf
