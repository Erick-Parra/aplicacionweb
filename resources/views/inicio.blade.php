...
<br>
       ...
       <div class="carousel-caption d-none d-md-block" style="height: 10px;">
        <br>
         <h5 style="font-family: Antic, sans-serif;color: #0D47A1; font-size: 16px;">ASESORÍA LEGAL</h5>
          <p style="font-family: Antic, sans-serif;color: #17202A; font-size: 16px;">Con tres asesores legales para dar servicios de asesoría legal y trámites legales a las ASADAS.</p>
    </div>
     </div>
  ...
  <a class="carousel-control-next" style="background-color: #003357;width: 20px;" href="#carouselExampleIndicators" role="button" data-slide="next">
